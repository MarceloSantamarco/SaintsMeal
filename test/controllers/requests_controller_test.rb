...
class RequestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create request" do
    assert_difference('Request.count') do
      post requests_url, params: { request: { amount: @request.amount, date: @request.date } }
    end
  ...
  test "should update request" do
    patch request_url(@request), params: { request: { amount: @request.amount, date: @request.date } }
